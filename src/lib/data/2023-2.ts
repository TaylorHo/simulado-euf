...
export default <Question[]>[
	{
		...
		tags: tagsForArea<Area.MecanicaClassica>(TagMC.ForcasCentrais, TagMC.GravitacaoNewtoniana),
		help: {
		...
		alternatives: [
			{
				text: String.raw`$L = \sqrt{GMm^2r}; \space E = -\frac{1}{2} \frac{GMm}{r}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$L = \sqrt{GMm^2r}; \space E = -\frac{GMm}{r}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$L = \sqrt{GM^2mr}; \space E = \frac{GMm}{r}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$L = \sqrt{GM^2mr}; \space E = -\frac{1}{2} \frac{GMm}{r^2}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$L = \sqrt{GMmr}; \space E = -\frac{GMm}{r^2}$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$L = \sqrt{GMm^2r}; \space K = \frac{1}{2} \frac{GMm}{r}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$L = \sqrt{GMm^2r}; \space K = -\frac{GMm}{r}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$L = \sqrt{GM^2mr}; \space K = \frac{GMm}{r}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$L = \sqrt{GM^2mr}; \space K = -\frac{1}{2} \frac{GMm}{r^2}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$L = \sqrt{GMmr}; \space K = \frac{GMm}{r^2}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Um sistema composto por uma massa $m$ acoplada a três molas ideais de constantes elásticas $k_1$, $k_2$ e $k_3$ está montado como mostrado na figura. A massa pode oscilar (longitudinalmente à direção das molas) em torno de seu ponto de equilíbrio sobre uma superfície de atrito desprezível. Determine a frequência angular $\omega_0$ de oscilação da massa. Assuma que, no equilíbrio, as molas estão relaxadas.`,
			image: '2023-2/mc-2a.webp'
		},
		alternatives: [
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{k_1 + k_2 + k_3}{m}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{(1/k_1) + k_2 + k_3}{m}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{k_1 + (1/k_2) + (1/k_3)}{m}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{(1/k_1) + (1/k_2) + (1/k_3)}{m}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{k_1}{m}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Um sistema composto por uma massa $m$ acoplada a quatro molas ideais, duas de constantes elásticas $k_1$ e as outras duas de constante elástica $k_2$, está montado como mostrado na figura. A massa pode oscilar (longitudinalmente à direção das molas) em torno de seu ponto de equilíbrio sobre uma superfície de atrito desprezível. Determine a frequência angular $\omega_0$ de oscilação da massa. Assuma que, no equilíbrio, as molas estão relaxadas.`,
			image: '2023-2/mc-2b.webp'
		},
		alternatives: [
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{2(k_1 + k_2)}{m}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{(\frac{1}{k_1 + k_2} + \frac{1}{k_1 + k_2})}{m}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{2(1/k_1) + 2(1/k_2)}{m}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{k_1 + k_2}{m}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\omega_0 = \sqrt{\frac{(\frac{1}{2k_1 + 2k_2})}{m}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		version: Version.A,
		area: Area.MecanicaClassica,
		tags: tagsForArea<Area.MecanicaClassica>(TagMC.OscilacoesLineares),
		help: {
			imageDescription: undefined,
			youtubeVideoId: videos[Area.MecanicaClassica]
		},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$r_0 = a$ e $k = \frac{6D}{a^2}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$r_0 = a$ e $k = \frac{13D}{a^2}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$r_0 = \frac{a}{\sqrt[6]{2}}$ e $k = \frac{6D}{a^2}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$r_0 = \frac{a}{\sqrt[6]{2}}$ e $k = \frac{13D}{a^2}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$r_0 = \frac{a}{2}$ e $k = \frac{D}{a^4}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Um disco uniforme de momento de inércia $I_1 = I$ é montado sobre um eixo vertical de massa desprezível e gira livremente com velocidade angular $\omega_0$. Em um dado instante, deixa-se cair sobre esse disco girante (de uma altura desprezível) um outro disco uniforme de momento de inércia $I_2 = I/2$ e velocidade angular nula, como mostrado na figura. Devido ao atrito entre as superfícies dos discos, eles passam a girar juntos com velocidade angular $\omega_f$ . Determine a velocidade angular final $\omega_f$ do conjunto dos dois discos, assumindo que o eixo de rotação do sistema passa pelo seu centro de simetria. A energia cinética (de rotação) se conserva no processo?`,
			image: '2023-2/mc-4a.webp'
		},
		alternatives: [
			{
				text: String.raw`$\omega_f = \frac{2}{3}\omega_0$. A energia cinética de rotação não se conserva.`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\omega_f = \frac{2}{3}\omega_0$. A energia cinética de rotação se conserva.`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\omega_f = \frac{3}{2}\omega_0$. A energia cinética de rotação não se conserva.`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\omega_f = \frac{3}{2}\omega_0$. A energia cinética de rotação se conserva.`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\omega_f = \frac{\sqrt{2}}{\sqrt{3}}\omega_0$. A energia cinética de rotação se conserva.`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\omega_f = \frac{1}{3}\omega_0$. A energia cinética de rotação não se conserva.`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\omega_f = \frac{1}{3}\omega_0$. A energia cinética de rotação se conserva.`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\omega_f = 3\omega_0$. A energia cinética de rotação não se conserva.`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\omega_f = 3\omega_0$. A energia cinética de rotação se conserva.`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\omega_f = \frac{\sqrt{3}}{3}\omega_0$. A energia cinética de rotação se conserva.`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		version: Version.A,
		area: Area.MecanicaClassica,
		tags: tagsForArea<Area.MecanicaClassica>(TagMC.MovimentoDuasTresDimensoes, TagMC.LeisDeNewton),
		help: {
			imageDescription: undefined,
			youtubeVideoId: videos[Area.MecanicaClassica]
		},
	...
	},
	{
		...
		questionNumber: 6,
		statement: {
			text: String.raw`Uma partícula de massa $m$ se move em uma dimensão sob a ação de uma força $F$. Verifica-se que a velocidade da partícula em termos da sua posição $x$ é dada por<br/><br/>$$v(x) = \frac{k}{x}$$<br/>onde $k$ é uma constante positiva. Determine a força $F(x)$ em função da posição $x$ da partícula.`
		},
		alternatives: [
			{
				text: '$F(x) = -mk^2/x^3$',
	...
	},
	{
		...
		questionNumber: 6,
		statement: {
			text: String.raw`Uma partícula de massa $m$ se move em uma dimensão sob a ação de uma força $F$. Verifica-se que a velocidade da partícula em termos da sua posição $x$ é dada por<br/><br/>$$v(x) = \frac{k}{x^2}$$<br/>onde $k$ é uma constante positiva. Determine a força $F(x)$ em função da posição $x$ da partícula.`
		},
		alternatives: [
			{
				text: '$F(x) = -2mk^2/x^5$',
	...
	},
	{
		...
		tags: tagsForArea<Area.MecanicaClassica>(
			...
			TagMC.ReferenciaisNaoInerciais
		),
		help: {
			imageDescription: undefined,
			youtubeVideoId: videos[Area.MecanicaClassica]
	...
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$V = \frac{1}{4\pi\epsilon_0} \frac{Q}{R_A + 2R_B}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$V = \frac{1}{4\pi\epsilon_0} \frac{Q}{2R_A + R_B}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$V = \frac{1}{4\pi\epsilon_0} \frac{Q}{3R_A - R_B}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Duas esferas condutoras, com raios iguais a $R_A$ e $R_B$, onde $R_A = 2R_B$, estão ligadas por um fio metálico com capacitância desprezível. A distância entre os centros das esferas é $d$, onde $d \gg R_A$. O sistema possui uma carga líquida total $Q$, distribuída entre as esferas. Qual é o potencial elétrico $V$ na superfície das esferas em termos de $Q$? Assuma $V = 0$ no infinito.`
		},
		alternatives: [
			{
				text: String.raw`$V = \frac{1}{4\pi\epsilon_0} \frac{Q}{(3R_B)}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$V = \frac{1}{4\pi\epsilon_0} \frac{Q}{R_B}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$V = \frac{1}{4\pi\epsilon_0} \frac{Q}{(4R_B)}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$V = \frac{1}{4\pi\epsilon_0} \frac{Q}{(5R_B)}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$V = \frac{1}{4\pi\epsilon_0} \frac{Q}{(2R_B)}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Duas espiras condutoras concêntricas $A$ e $B$, com raios iguais a $a$ e $b$, respectivamente, estão inicialmente contidas em um mesmo plano. Considere $b \gg a$. No instante $t = 0$, a espira $A$, com resistência $R$, começa a girar em torno de um de seus diâmetros com frequência angular constante $\omega$, enquanto a espira $B$ permanece em repouso. Se uma corrente elétrica $I_B$ constante circula na espira $B$, qual é a força eletromotriz $\varepsilon$ induzida na espira $A$? Despreze efeitos de auto-indutância.`
		},
		alternatives: [
			{
				text: String.raw`$\varepsilon = \frac{\mu_0\omega I_B \pi a^2}{2b} \sin{(\omega t)}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\varepsilon = \frac{\mu_0\omega I_B \pi a^2}{2b} \cos{(\omega t)}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\varepsilon = \frac{\mu_0\omega I_B \pi b^2}{4a} \sin{(\omega t)}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\varepsilon = \frac{\mu_0\omega I_B \pi b^2}{4a} \cos{(\omega t)}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\varepsilon = \frac{\mu_0\omega I_B a^2}{2\pi b} \sin{(\omega t)}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Duas espiras condutoras concêntricas $A$ e $B$, com raios iguais a $a$ e $b$, respectivamente, estão inicialmente contidas em um mesmo plano. Considere $b \gg a$. No instante $t = 0$, a espira $A$, com resistência $R$, começa a girar em torno de um de seus diâmetros com frequência angular constante $\omega$, enquanto a espira $B$ permanece em repouso. Se uma corrente elétrica $I_B$ constante circula na espira $B$, qual é a corrente elétrica $I_A$ induzida na espira $A$? Despreze efeitos de auto-indutância.`
		},
		alternatives: [
			{
				text: String.raw`$I_A = \frac{\mu_0\omega I_B \pi a^2}{2Rb} \sin{(\omega t)}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$I_A = \frac{\mu_0\omega I_B \pi a^2}{2Rb} \cos{(\omega t)}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$I_A = \frac{\mu_0\omega I_B \pi b^2}{4Ra} \sin{(\omega t)}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$I_A = \frac{\mu_0\omega I_B \pi b^2}{4Ra} \cos{(\omega t)}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$I_A = \frac{\mu_0\omega I_B a^2}{2\pi Rb} \sin{(\omega t)}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`Um capacitor de capacitância $C$ está totalmente carregado com uma carga $Q_0$ e com uma energia total armazenada igual a $U_0$. No instante $t = 0$ o capacitor começa a descarregar através de um resistor de resistência $R$. Em termos da constante de tempo $\tau = RC$, em qual instante $t'$ o capacitor terá um quarto de sua energia inicial $U_0$?`
		},
		alternatives: [
			{
				text: String.raw`$t' = \frac{\ln{(4)}}{2}\tau$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$t' = \frac{\ln{(2)}}{4}\tau$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$t' = 4\tau$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$t' = 2\tau$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$t' = \frac{\tau}{4}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$t' = \frac{\ln{(3)}}{2}\tau$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$t' = \frac{\ln{(2)}}{3}\tau$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$t' = 3\tau$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$t' = 2\tau$`,
	...
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`O campo elétrico no interior de um capacitor de placas paralelas circulares é dado por $E = E_0 (t/\tau )^2\hat{z}$. Qual é o campo magnético $B$ induzido entre as placas?`
		},
		alternatives: [
			{
				text: String.raw`$B = r \mu_0 \epsilon_0 E_0 \frac{t}{\tau^2} \hat{\varphi}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$B = r \mu_0 \epsilon_0 E_0 \frac{t}{\tau^2} \hat{z}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$B = \pi r \mu_0 \epsilon_0 E_0 \frac{t}{\tau^2} \hat{\varphi}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$B = \pi r \mu_0 \epsilon_0 E_0 \frac{t}{\tau^2} \hat{z}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$B = 2\pi r \mu_0 \epsilon_0 E_0 \frac{t}{\tau^2} \hat{\varphi}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`O campo elétrico no interior de um capacitor de placas paralelas circulares é dado por $E = E_0 (t/\tau )\hat{z}$. Qual é o campo magnético $B$ induzido entre as placas?`
		},
		alternatives: [
			{
				text: String.raw`$B = r \mu_0 \epsilon_0 \frac{E_0}{2\tau} \hat{\varphi}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$B = r \mu_0 \epsilon_0 \frac{E_0}{2\tau} \hat{z}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$B = \pi r \mu_0 \epsilon_0 \frac{E_0}{2\tau} \hat{\varphi}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$B = \pi r \mu_0 \epsilon_0 \frac{E_0}{2\tau} \hat{z}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$B = \pi r \mu_0 \epsilon_0 \frac{E_0}{\tau} \hat{\varphi}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$0{,}96 \space mV$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$9{,}6 \space mV$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$9{,}6 \space \mu V$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$0{,}96 \space \mu V$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$96 \space \mu V$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$0{,}63 \space mV$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$63 \space \mu V$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$6{,}3 \space \mu V$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$0{,}63 \space \mu V$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$6{,}3 \space mV$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 8,
		statement: {
			text: String.raw`A figura abaixo ilustra a seção reta de dois condutores cilíndricos paralelos idênticos e muito longos (parte cinza) que carregam, em sentidos opostos, densidades de corrente de módulo $J$ uniformemente distribuídas em seu interior. Essa distribuição de correntes é equivalente àquela advinda de dois cilindros paralelos muito longos de seção reta circular de raio $R$, cujos eixos distam de $d < R$, tal que as correntes se cancelem na parte superposta (região branca). Qual é o campo magnético $\vec{B}$ no ponto $P$, que está (verticalmente) a uma distância $a$ do ponto médio do segmento que une os eixos dos cilindros e é normal a eles?`,
			image: '2023-2/em-8a.webp'
		},
		alternatives: [
			{
				text: String.raw`$\vec{B} = \frac{1}{2} \mu_0 J d\hat{y}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\vec{B} = \frac{1}{2} \mu_0 J \frac{ad}{R}\hat{y}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\vec{B} = -\frac{1}{2} \mu_0 J \sqrt{\left(\frac{d}{2}\right)^2 + a^2}\hat{y}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\vec{B} = -\frac{1}{2} \mu_0 J \frac{(\frac{d}{2})^2 + a^2}{R}\hat{y}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\vec{B} = \frac{1}{2} \mu_0 J \frac{\left((\frac{d}{2})^2 + a^2\right)^{3/2}}{R^2}\hat{y}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$\vec{B} = -\frac{1}{2} \mu_0 J \sqrt{(d - a)^2 + a^2}\hat{y}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\vec{B} = -\frac{1}{2} \mu_0 J \frac{(d - a)^2 + a^2}{R}\hat{y}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\vec{B} = \frac{1}{2} \mu_0 J \frac{\left((d - a)^2 + a^2\right)^{3/2}}{R^2}\hat{y}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		version: Version.A,
		area: Area.FisicaModerna,
		tags: tagsForArea<Area.FisicaModerna>(TagFM.DistribuicaoBoltzmannEnergia),
		help: {
			imageDescription: undefined,
			youtubeVideoId: videos[Area.FisicaModerna]
		},
		...
		alternatives: [
			{
				text: String.raw`$\sqrt{\frac{m_D}{m_N}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\sqrt{\frac{m_N}{m_D}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\frac{m_D}{m_N}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{m_N}{m_D}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{m_D - m_N}{m_D}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\frac{7h}{24\pi M d^2} n$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\frac{h}{\pi M d^2} n$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\frac{7h}{12\pi M d^2} n$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{6h}{7\pi M d^2} n$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{7h}{6\pi M d^2} n$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\frac{5h}{12\pi M d^2} n$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\frac{h}{\pi M d^2} n$`,
			...
			{
				text: String.raw`$\frac{5h}{6\pi M d^2} n$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{3h}{5\pi M d^2} n$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{5h}{3\pi M d^2} n$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`O experimento de Millikan, que permitiu obter o valor da carga elétrica $q$ do elétron de massa $m_0$, baseia-se na investigação da queda em condições de equilíbrio de gotículas de óleo carregadas eletricamente e sujeitas às forças de arrasto, do tipo $\vec{F}_a = -b\vec{v}$ (onde $b$ é uma constante), e elétrica, devido a um campo elétrico aplicado $\vec{E}$ . Considere uma variante deste experimento, na qual $\vec{E}$ é aplicado horizontalmente. Ajustando-se o módulo do campo elétrico $E$, as gotículas passam a cair com velocidade constante em uma trajetória retilínea formando um ângulo $\theta$ com a vertical. Se $v_T$ for a velocidade terminal das gotículas ao longo da trajetória, a carga elétrica pode ser obtida de:`
		},
		alternatives: [
			{
				text: String.raw`$q = \frac{bv_T}{E} \sin{(\theta)}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$q = \frac{bv_T}{E} \cos{(\theta)}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$q = \frac{bv_T}{E} \tan{(\theta)}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$q = \frac{E}{bv_T} \sin{(\theta)}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$q = \frac{m_0g}{bv_T} \cos{(\theta)}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$1{,}4 \times 10^9$ km`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$8{,}5 \times 10^8$ km`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$1{,}0 \times 10^9$ km`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$9{,}2 \times 10^8$ km`,
				number: QuestionAlternative.D
			},
			{
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$1{,}1 \times 10^9$ km`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$8{,}4 \times 10^8$ km`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$1{,}8 \times 10^9$ km`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$9{,}7 \times 10^8$ km`,
				number: QuestionAlternative.D
			},
			{
				text: 'Não há dados suficientes para responder a pergunta',
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$4{,}12 \space MeV/c^2$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$3{,}00 \space MeV/c^2$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$3{,}67 \space MeV/c^2$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$4{,}67 \space MeV/c^2$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$5{,}00 \space MeV/c^2$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$3{,}32 \space MeV/c^2$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$3{,}00 \space MeV/c^2$`,
			...
			{
				text: String.raw`$2{,}67 \space MeV/c^2$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$3{,}86 \space MeV/c^2$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$4{,}00 \space MeV/c^2$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 7,
		statement: {
			text: String.raw`Uma amostra é preparada contendo $1{,}0 \times 10^{20}$ partículas radioativas de vida média igual a $1{,}0$ ano. Em cada decaimento, 10 fótons de comprimento de onda $1{,}0$ pm são emitidos. Qual a taxa de produção de energia eletromagnética após $1{,}0$ ano da amostra ter sido preparada?`
		},
		alternatives: [
			{
				text: '$2{,}3$ W',
	...
	},
	{
		...
		area: Area.FisicaModerna,
		tags: tagsForArea<Area.FisicaModerna>(
			TagFM.RadiacaoTermicaCorpoNegroPlanck,
			TagFM.TransformacoesLorentz
		),
		help: {
			imageDescription: undefined,
		...
		alternatives: [
			{
				text: String.raw`$8{,}3 \times 10^3 \space K$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$4{,}1 \times 10^3 \space K$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$7{,}2 \times 10^3 \space K$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$3{,}0 \times 10^3 \space K$`,
				number: QuestionAlternative.D
			},
			{
	...
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$4{,}8 \times 10^3 \space K$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$6{,}2 \times 10^3 \space K$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$3{,}0 \times 10^3 \space K$`,
	...
	},
	{
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Considere a dinâmica quântica de uma partícula em uma dimensão. A figura abaixo mostra três possibilidades para o módulo quadrado da função de onda dessa partícula, $|\Psi(x)|^2$, num determinado instante, para diferentes valores do parâmetro $b$. Marque a afirmativa correta:`,
	...
	},
	{
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Considere a dinâmica quântica de uma partícula em uma dimensão. A figura abaixo mostra três possibilidades para o módulo quadrado da função de onda dessa partícula, $|\Psi(x)|^2$, num determinado instante, para diferentes valores do parâmetro $a$. Marque a afirmativa correta:`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$0$, $0$, $\frac{0{,}75 L^2}{\pi^2}$, $\frac{9\pi^2\hbar^2}{L^2}$, $2{,}6 \hbar$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$0$, $0$, $\frac{0{,}010 L^2}{\pi^2}$, $\frac{9\pi^2\hbar^2}{L^2}$, $0{,}30 \hbar$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$0$, $0$, $\frac{0{,}010 L^2}{\pi^2}$, $\frac{9\pi^2\hbar^2}{L^2}$, $2{,}6 \hbar$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$0$, $0$, $\frac{0{,}75 L^2}{\pi^2}$, $\frac{9\pi^2\hbar^2}{L^2}$, $0{,}30 \hbar$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$0$, $\sqrt{0{,}1}\frac{3\pi \hbar}{L}$, $\frac{0{,}75 L^2}{\pi^2}$, $1{,}1 \frac{9\pi^2\hbar^2}{L^2}$, $2{,}6 \hbar$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\sqrt{0{,}5}$ e $1{,}7 \hbar\omega$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$0{,}5$ e $1{,}7 \hbar\omega$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$0{,}5$ e $1{,}1 \hbar\omega$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\sqrt{0{,}5}$ e $1{,}1 \hbar\omega$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$0{,}25$ e $0{,}61 \hbar\omega$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$-2\hbar$ e $2\hbar$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$-\hbar$, $0$ e $\hbar$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$-\hbar/2$ e $\hbar/2$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		questionNumber: 7,
		statement: {
			text: String.raw`Considere dois spins $1/2$, $\vec{S_1}$ e $\vec{S_2}$, cuja interação é descrita por meio do hamiltoniano<br/><br/>$$H = \frac{J}{\hbar^2}\vec{S_1} \cdot \vec{S_1} = \frac{J}{\hbar^2} (S_1^x S_2^x + S_1^y S_2^y + S_1^z S_2^z) \space \text{,}$$<br/>em que $J > 0$ tem dimensão de energia. A energia do estado fundamental desse sistema é:`
		},
		alternatives: [
			{
				text: '$-3J/4$',
	...
	},
	{
		...
		tags: tagsForArea<Area.Termodinamica>(
			...
			TagTD.EquivalenteMecanicoCalor
		),
		help: {
			imageDescription: undefined,
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Um líquido de massa $m$ e calor específico $c$ deve ser aquecido por uma variação de temperatura $\Delta T$, sem alcançar a ebulição. Para isso, um resistor de resistência $R$ é conectado a uma pilha de resistência interna insignificante. O resistor é inserido no líquido em uma cuba, conforme mostrado na figura. O tempo $\Delta t$ necessário para alcançar a variação de temperatura é cronometrado. Se todo o calor gerado pelo resistor é transferido para o líquido, qual é a força eletromotriz da pilha?`,
			image: '2023-2/te-1.webp'
		},
		alternatives: [
			{
				text: String.raw`$\epsilon = \sqrt{\frac{R m c \Delta{T}}{\Delta{t}}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\epsilon = \sqrt{\frac{2R m c \Delta{T}}{\Delta{t}}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\epsilon = 3\sqrt{\frac{R m c \Delta{T}}{\Delta{t}}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\epsilon = \sqrt{\frac{3R m c \Delta{T}}{\Delta{t}}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\epsilon = 2\sqrt{\frac{R m c \Delta{T}}{\Delta{t}}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		area: Area.Termodinamica,
		tags: tagsForArea<Area.Termodinamica>(
			TagTD.AplicacoesPraticasTermodinamica,
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Uma casa está a uma temperatura absoluta de equilíbrio $T$, sendo aquecida por meio de uma bomba de calor que retira calor de um rio que se encontra à temperatura absoluta $T_0$, consumindo uma potência constante $dW/dt = \lambda$. O coeficiente de desempenho $\eta$ de uma bomba de calor é a razão entre o calor que a bomba fornece e o trabalho necessário para operá-la, ambos ao longo de um ciclo de operação. A casa perde calor para o ambiente externo a uma taxa dada por $\alpha(T - T_0)$, onde $\alpha$ é uma constante. A temperatura de equilíbrio $T$ da casa é:`
		},
		alternatives: [
			{
				text: String.raw`$T_0 + \frac{\eta \lambda}{\alpha}$`,
				number: QuestionAlternative.A
			},
			{
				text: '$T_0$',
			...
			{
				text: String.raw`$T_0 + \frac{2\eta \lambda}{\alpha}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$T_0 + \frac{\lambda}{\alpha}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$T_0 + \frac{2\lambda}{\alpha}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\eta = \frac{\alpha (T - T_0)}{\lambda}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\eta = \frac{\alpha T}{\lambda}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\eta = \frac{\alpha T_0}{\lambda}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\eta = \frac{\lambda}{\alpha (T - T_0)}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\eta = \frac{\lambda}{\alpha T}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Um gás ideal monoatômico é descrito pelas equações<br/><br/>$$pV = nRT \qquad e \qquad U = \frac{3}{2}nRT$$<br/>onde $n$ é o número de moles e $R$ é a constante universal dos gases. Em determinados processos de compressão, a temperatura e o volume do gás variam de um estado inicial dado por ($T_0,V_0$) até um estado qualquer dado por ($T,V$) obedecendo a relação<br/><br/>$$T = \left(\frac{V}{V_0}\right)^x T_0$$<br/>onde $x$ é uma constante não nula. O trabalho $W$ realizado pelo gás num processo desse tipo para um valor genérico de $x$, ao ser comprimido a partir de ($T_0,V_0$) até o volume final $V_1$, e o valor de $x$ tal que o calor transferido para o gás no mesmo processo seja nulo são dados por:`
		},
		alternatives: [
			{
				text: String.raw`$W = \frac{nRT_0}{x} \left[\left(\frac{V_1}{V_0}\right)^x - 1\right]$ e $x = -\frac{2}{3}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$W = \frac{nRT_0}{2}$ e $x = -1$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$W = \frac{nRT_0}{2} \ln{\frac{V_1}{V_0}}$ e $x = -\frac{1}{3}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$W = \frac{nRT_0}{x} \left[\left(\frac{V_1}{V_0}\right)^{2x} - 1\right]$ e $x = -\frac{2}{3}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$W = \frac{nRT_0}{x} \left[\left(\frac{V_1}{V_0}\right)^x - 1\right]$ e $x = 0$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Um gás ideal diatômico é descrito pelas equações<br/><br/>$$pV = nRT \qquad e \qquad U = \frac{5}{2}nRT$$<br/>onde $n$ é o número de moles e $R$ é a constante universal dos gases. Em determinados processos de compressão, a temperatura e o volume do gás variam de um estado inicial dado por ($T_0,V_0$) até um estado qualquer dado por ($T,V$) obedecendo a relação<br/><br/>$$T = \left(\frac{V}{V_0}\right)^x T_0$$<br/>onde $x$ é uma constante não nula. O trabalho $W$ realizado pelo gás num processo desse tipo para um valor genérico de $x$, ao ser comprimido a partir de ($T_0,V_0$) até o volume final $V_1$, e o valor de $x$ tal que o calor transferido para o gás no mesmo processo seja nulo são dados por:`
		},
		alternatives: [
			{
				text: String.raw`$W = \frac{nRT_0}{x} \left[\left(\frac{V_1}{V_0}\right)^x - 1\right]$ e $x = -\frac{2}{5}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$W = \frac{nRT_0}{2}$ e $x = -1$`,
			...
			{
				text: String.raw`$W = \frac{nRT_0}{2} \ln{\frac{V_1}{V_0}}$ e $x = -\frac{2}{9}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$W = \frac{nRT_0}{x} \left[\left(\frac{V_1}{V_0}\right)^x - 1\right]$ e $x = -\frac{2}{3}$`,
			...
			{
				text: String.raw`$W = \frac{nRT_0}{3x} \left[\left(\frac{V_1}{V_0}\right)^{3x} - 1\right]$ e $x = 0$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Considere um sistema de duas partículas interagentes 1 e 2, ambas em contato com um mesmo reservatório térmico de temperatura $T \left[\beta = (k_BT)^{-1}\right]$. Cada partícula é caracterizada pela variável $n_i$ ($i = 1, 2$), que pode assumir os valores 0 ou 1. A energia do sistema vale $\epsilon(n_1 + n_2)$ se $n_1 \neq n_2$ e $\epsilon(n_1 + n_2) + \Delta$ se $n_1 = n_2$, onde $\epsilon$ e $\Delta$ são constantes positivas. A probabilidade do sistema estar no estado de maior energia é dada por:`
		},
		alternatives: [
			{
				text: String.raw`$\frac{e^{-\beta (2\epsilon + \Delta)}}{e^{-\beta \Delta} + 2e^{-\beta \epsilon} + e^{-\beta (2\epsilon + \Delta)}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\frac{e^{-\beta \Delta}}{e^{-\beta \Delta} + 2e^{-\beta \epsilon} + e^{-\beta (2\epsilon + \Delta)}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\frac{e^{-\beta \Delta}}{e^{-\beta \Delta} + e^{-\beta \epsilon} + e^{-\beta (\epsilon + \Delta)}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{e^{-\beta \Delta}}{e^{-\beta \Delta} + 2e^{-\beta \epsilon} + e^{-2\beta \epsilon}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{1}{1 + 2e^{-\beta \epsilon} + e^{-2\beta \epsilon}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$U = N \epsilon \left(\frac{e^{\beta \epsilon} + 1}{e^{\beta \epsilon} - 1}\right)$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$U = N \epsilon \left(\frac{e^{\beta \epsilon} - 1}{e^{\beta \epsilon} + 1}\right)$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$U = \frac{2N\epsilon}{e^{2\beta \epsilon} - 1}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$U = N \epsilon \left(\frac{e^{\beta \epsilon} - 1}{e^{\beta \epsilon} + 1}\right)$`,
			...
			{
				text: String.raw`$U = \frac{N\epsilon}{e^{\beta \epsilon} - 1}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$U = N \epsilon \left(\frac{e^{\beta \epsilon} + 1}{e^{\beta \epsilon} - 1}\right)$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$Z = \frac{\pi}{\beta h \omega} (1 + e^{-\beta \epsilon})$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$Z = \frac{\pi}{\beta h \omega}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$Z = \frac{\pi}{\beta h \omega} (1 - e^{-\beta \epsilon})$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$Z = \frac{2\pi}{\beta h \omega} \cosh \left(\frac{\beta \epsilon}{2}\right)$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$Z = \frac{2\pi}{\beta h \omega} \sinh \left(\frac{\beta \epsilon}{2}\right)$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$Z = \frac{2\pi}{\beta h \omega} (1 + e^{-\frac{\beta \epsilon}{2}})$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$Z = \frac{\pi}{\beta h \omega}$`,
			...
			{
				text: String.raw`$Z = \frac{\pi}{\beta h \omega} (1 - e^{\frac{\beta \epsilon}{2}})$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$q = \frac{9e^{-9\beta D} \cosh{(3\beta\mu_0h)} + e^{-\beta D} \cosh{(\beta\mu_0h)}}{e^{-9\beta D} \cosh{(3\beta\mu_0h)} + e^{-\beta D} \cosh{(\beta\mu_0h)}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$q = \frac{9e^{-9\beta D} \sinh{(3\beta\mu_0h)} + e^{-\beta D} \sinh{(\beta\mu_0h)}}{e^{-9\beta D} \cosh{(3\beta\mu_0h)} + e^{-\beta D} \cosh{(\beta\mu_0h)}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$q = -\frac{9e^{9\beta D} \sinh{(3\beta\mu_0h)} + e^{\beta D} \sinh{(\beta\mu_0h)}}{e^{9\beta D} \cosh{(3\beta\mu_0h)} + e^{\beta D} \cosh{(\beta\mu_0h)}}$`,
			...
			{
				text: String.raw`$q = \frac{2 \cosh{(\beta\mu_0h)}}{e^{\beta D} + 2 \cosh{(\beta\mu_0h)}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$m = \frac{3\mu_0 e^{-9\beta D} \sinh{(3\beta\mu_0h)} + \mu_0 e^{-\beta D} \sinh{(\beta\mu_0h)}}{e^{-9\beta D} \cosh{(3\beta\mu_0h)} + e^{-\beta D} \cosh{(\beta\mu_0h)}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$m = \frac{3\mu_0 e^{9\beta D} \sinh{(3\beta\mu_0h)} + \mu_0 e^{\beta D} \sinh{(\beta\mu_0h)}}{e^{9\beta D} \cosh{(3\beta\mu_0h)} + e^{\beta D} \cosh{(\beta\mu_0h)}}$`,
			...
			{
				text: String.raw`$m = 2\mu_0 \tanh{(\beta\mu_0h)} (e^{-9\beta D} \cosh{(3\beta\mu_0h)} + e^{-\beta D} \cosh{(\beta\mu_0h)})$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$m = 2\mu_0 \tanh{(\beta\mu_0h)}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$m = \frac{\mu_0 e^{\beta D}}{e^{-9\beta D} \cosh{(3\beta\mu_0h)} + e^{-\beta D} \cosh{(\beta\mu_0h)}}$`,
				number: QuestionAlternative.E
			}
		]
	}
