...
export default <Question[]>[
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$\frac{v_1}{v_2} = \frac{1}{3}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{v_1}{v_2} = \sqrt{\frac{1}{2}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{v_1}{v_2} = \frac{1}{2}$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\frac{v_1}{v_2} = \sqrt{\frac{1}{5}}$`,
				number: QuestionAlternative.A
			},
			{
				text: 'Nenhuma das outras alternativas.',
			...
			{
				text: String.raw`$\frac{v_1}{v_2} = \frac{1}{5}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{v_1}{v_2} = \sqrt{\frac{1}{3}}$`,
	...
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Uma partícula de prova está em repouso sobre a superfície de um astro de densidade uniforme $\rho$ e perfeitamente esférico de raio $R$. O astro começa a girar (com velocidade angular $\omega$ aumentando muito lentamente) em torno de um eixo que passa por seu centro, com a partícula sobre o equador. Sendo $\mu > 0$ o coeficiente de atrito entre essa partícula e o astro, e $G$ a constante da gravitação universal, qual a máxima velocidade angular de rotação que a partícula pode ter?`
		},
		alternatives: [
			{
				text: String.raw`$\omega_{\max} = \sqrt{\frac{4\pi\rho G}{3}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\omega_{\max} = \omega$. Como a velocidade angular aumenta muito lentamente e $\mu > 0$, a máxima velocidade angular da partícula é a mesma do astro.`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\omega_{\max} = \sqrt{\frac{4\pi\mu\rho G}{3}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\omega_{\max} = \sqrt{\frac{4\pi\sqrt{1 + \mu^2}\rho G}{3}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\omega_{\max} = \sqrt{\frac{4\pi|1 - \mu^2|\rho G}{3}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$\omega_{\max} = \sqrt{\frac{\mu GM}{R^3}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\omega_{\max} = \sqrt{\frac{\sqrt{1 + \mu^2}GM}{R^3}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\omega_{\max} = \sqrt{\frac{\sqrt{|1 - \mu^2|}GM}{R^3}}$`,
	...
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`A figura (a) ilustra a força $F$ necessária para causar uma deformação $\Delta x$ em uma mola nada convencional. Faz-se então um experimento em que se aplica uma força $F$ variável no tempo $(t)$ sobre essa mola, como ilustra a figura (b). (Os eixos verticais de ambas figuras estão na mesma escala.) Qual dos gráficos abaixo melhor ilustra a deformação da mola como função do tempo?`,
	...
	},
	{
		...
		version: Version.A,
		area: Area.MecanicaClassica,
		tags: tagsForArea<Area.MecanicaClassica>(TagMC.DinamicaCorposRigidos),
		help: {
			youtubeVideoId: videos[Area.MecanicaClassica]
		},
		questionNumber: 4,
		statement: {
			text: String.raw`Certas nebulosas brilham às custas da energia de rotação de sua estrela de nêutrons. Tratando essa estrela como uma esfera homogênea de raio $R$ e massa $M$, calcule a potência emitida pela nebulosa, sendo que o período de rotação da estrela é $T$ e que esse período aumenta a uma taxa constante $\gamma = dT/dt$.`
		},
		alternatives: [
			{
				text: String.raw`$\frac{8\pi^2\gamma MR^2}{5T^3}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\frac{8\pi^2\gamma MR^2}{3T^3}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\frac{1}{2}\frac{M}{T}\left(\frac{2\pi R}{T} \gamma\right)^2$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{1}{2}\frac{M}{T}\gamma\left(\frac{2\pi R}{T}\right)^2$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{1}{2}\frac{M}{T}\left(\frac{R}{T} \gamma\right)^2$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\frac{5PT^3}{8\pi^2 MR^2}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\frac{3PT^3}{8\pi^2 MR^2}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\frac{\sqrt{2PT^3/M}}{2\pi R}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{2PT^3}{M(2\pi R)^2}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{\sqrt{2PT^3/M}}{R}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$d = 2\sqrt{(H - h)h}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$d = 2\sqrt{Hh}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$d = \sqrt{2(H - h)h}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$d = \sqrt{2Hh}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$d = \sqrt{(H + h)h}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\sqrt{\frac{3k}{M}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\sqrt{\frac{k}{M}}$`,
			...
			{
				text: String.raw`$\sqrt{\frac{12k}{M}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\sqrt{\frac{4k}{M}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\sqrt{\frac{k}{4M}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 8,
		statement: {
			text: String.raw`Considere uma partícula de massa $m$ em um sistema bidimensional, sob ação de forças tais que a sua lagrangiana é dada por<br/><br/>$$\mathcal{L}(x, y, \dot{x}, \dot{y}, t) = \frac{m}{2}(\dot{x}^2 + \dot{y}^2) + x\dot{y}b(t) \space \text{,}$$<br/>onde $b(t)$ é uma função conhecida do tempo. Determine a hamiltoniana $\mathcal{H}(x, y, p_x, p_y, t)$ correspondente a esse sistema.`
		},
		alternatives: [
			{
				text: String.raw`$\mathcal{H} = \frac{1}{2m}p_x^2 + \frac{1}{2m}[p_y - b(t)x]^2$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\mathcal{H} = \frac{1}{2m}p_x^2 + \frac{1}{2m}[p_y + b(t)x]^2$`,
			...
			{
				text: String.raw`$\mathcal{H} = \frac{1}{2m}[p_x + b(t)y]^2 + \frac{1}{2m}p_y^2$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\mathcal{H} = \frac{1}{2m}[p_x - b(t)y]^2 + \frac{1}{2m}p_y^2$`,
			...
			{
				text: String.raw`$\mathcal{H} = \frac{1}{2m}p_x^2 + \frac{1}{2m}p_y^2$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`(I) $m\ddot{x} - \dot{y}b(t) = 0$; (II) $m\ddot{y} + \dot{x}b(t) + x\frac{d}{dt}b(t) = 0$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`(I) $m\ddot{x} - \dot{y}b(t) = 0$; (II) $m\ddot{y} + \dot{x}b(t) = 0$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`(I) $m\ddot{x} + \dot{y}b(t) = 0$; (II) $m\ddot{y} - \dot{x}b(t) - x\frac{d}{dt}b(t) = 0$`,
			...
			{
				text: String.raw`(I) $m\ddot{x} - \dot{y}b(t) = 0$; (II) $m\ddot{y} + x\frac{d}{dt}b(t) = 0$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Um capacitor de placas paralelas possui placas de área $A$ separadas por uma distância $D$. Entre as placas, na região $0 < z < D/2$ (medida ao longo de um eixo $z$ perpendicular às placas), há um dielétrico de constante $\kappa_1$, enquanto na região $D/2 < z < D$, há um dielétrico de constante $\kappa_2$. Qual é a capacitância equivalente $C$ do capacitor?`
		},
		alternatives: [
			{
				text: String.raw`$C = \frac{2\epsilon_0 A}{D} \frac{\kappa_1\kappa_2}{\kappa_1 + \kappa_2}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$C = \frac{\epsilon_0 A}{D} \frac{\kappa_1\kappa_2}{\kappa_1 + \kappa_2}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$C = \frac{2\epsilon_0 A}{D} \frac{\kappa_1 + \kappa_2}{\kappa_1\kappa_2}$`,
			...
			{
				text: String.raw`$C = \frac{\epsilon_0 A}{D} \frac{\kappa_1\kappa_2 + 1}{\kappa_1 + \kappa_2}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Um capacitor de placas paralelas possui placas de área $A$ separadas por uma distância $D$. Entre as placas, na região $0 < z < D/2$ (medida ao longo de um eixo $z$ perpendicular às placas), há um dielétrico de constante $\kappa$, enquanto na região $D/2 < z < D$ há vácuo. Qual é a capacitância equivalente $C$ do capacitor?`
		},
		alternatives: [
			{
				text: String.raw`$C = \frac{2\epsilon_0 A}{D} \frac{\kappa}{\kappa + 1}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$C = \frac{\epsilon_0 A}{D} \frac{\kappa}{\kappa + 1}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$C = \frac{2\epsilon_0 A}{D} \frac{\kappa + 1}{\kappa}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$C = \frac{\epsilon_0 A}{D} \frac{\kappa + 1}{\kappa}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$C = \frac{\epsilon_0 A}{D} \frac{\kappa - 1}{\kappa + 1}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Considere o potencial vetor magnético $\bm{A} = (\alpha x + \beta e^{\gamma y})\hat{x} + \delta\cos(\epsilon x)\hat{y}$, onde $\alpha$, $\beta$, $\gamma$, $\delta$ e $\epsilon$ são constantes. Qual é o campo magnético $\bm{B}$ na origem do sistema de coordenadas?`
		},
		alternatives: [
			{
				text: String.raw`$\bm{B} = -\beta\gamma\hat{z}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\bm{B} = \beta\epsilon\hat{z}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\bm{B} = \beta\hat{x} + \delta\hat{y} - \alpha\hat{z}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\bm{B} = \beta\hat{x} - \epsilon\hat{y} + \alpha\hat{z}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\bm{B} = \beta\gamma\hat{x}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Considere o potencial vetor magnético $\bm{A} = (\alpha x + \beta e^{\gamma y})\hat{y} + \delta\cos(\epsilon x)\hat{z}$, onde $\alpha$, $\beta$, $\gamma$, $\delta$ e $\epsilon$ são constantes. Qual é o campo magnético $\bm{B}$ na origem do sistema de coordenadas?`
		},
		alternatives: [
			{
				text: String.raw`$\bm{B} = \alpha\hat{z}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\bm{B} = \beta\gamma\hat{x} - \alpha\hat{z}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\bm{B} = \beta\hat{x} + \gamma\hat{y} - \alpha\hat{z}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\bm{B} = \beta\hat{x} - \epsilon\hat{y} + \alpha\hat{z}$`,
			...
			{
				text: String.raw`$\bm{B} = \beta\hat{x}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`Considere um campo elétrico dado por $\bm{E} = (k/r)\hat{r}$, onde $k$ é constante. Qual é o trabalho $W$ realizado pelo campo elétrico para mover uma carga pontual $q$ de um ponto $r$ até um ponto $2r$?`
		},
		alternatives: [
			{
				text: String.raw`$W = kq\ln 2$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$W = 2\pi kq\ln 2$`,
				number: QuestionAlternative.B
			},
			{
				text: '$W = kq$',
	...
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`Considere um campo elétrico dado por $\bm{E} = (k/r)\hat{r}$, onde $k$ é constante. Qual é o trabalho $W$ realizado pelo campo elétrico para mover uma carga pontual $q$ de um ponto $r$ até um ponto $3r$?`
		},
		alternatives: [
			{
				text: String.raw`$W = kq\ln 3$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$W = kq\ln 2$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$V(r) = \left(\frac{2a}{r} - 1\right)V_0$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$V(r) = 2 \left(\frac{a}{r} - 1\right)V_0$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$V(r) = \left(2 - \frac{r}{a}\right)V_0$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$V(r) = \left(\frac{2r}{a} - 1\right)V_0$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$V(r) = \left(\frac{a}{2r} - \frac{1}{2}\right)V_0$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$V(r) = \left(\frac{3a}{r} - 1\right)\frac{V_0}{2}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$V(r) = \left(\frac{3a}{r} - 1\right)V_0$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$V(r) = \left(3 - \frac{r}{a}\right)\frac{V_0}{2}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$V(r) = \left(\frac{3r}{a} - 1\right)V_0$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$V(r) = \left(\frac{a}{3r} - \frac{1}{3}\right)V_0$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 5,
		statement: {
			text: String.raw`Na figura, representamos um fio longo carregado, cuja densidade linear de carga é $\lambda$. A figura mostra um cilindro de altura $h$ e base com raio $r$, cujo eixo coincide com o fio. O módulo $E$ do campo elétrico a uma distância $r$ do fio e o módulo do fluxo $\Phi_E$ de campo elétrico através das bases do cilindro, são, respectivamente:`,
			image: '2025-2/em-5.webp'
		},
		alternatives: [
			{
				text: String.raw`$E = \frac{\lambda}{2\pi\epsilon_0 r}$ e $\Phi_E = 0$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$E = \frac{\lambda}{2\pi\epsilon_0 r}$ e $\Phi_E = \frac{\lambda h}{\epsilon_0}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$E = 0$ e $\Phi_E = \frac{\lambda h}{\epsilon_0}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$E = \frac{\lambda}{2\pi\epsilon_0 r}$ e $\Phi_E = \frac{\pi r^2\lambda}{\epsilon_0}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$E = 0$ e $\Phi_E = 0$, pois a carga total no fio é nula.`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 5,
		statement: {
			text: String.raw`Na figura, representamos um fio longo carregado, cuja densidade linear de carga é $\lambda$. A figura mostra um cilindro de altura $h$ e base com raio $r$, cujo eixo coincide com o fio. O módulo $E$ do campo elétrico $\Phi_E$ e o módulo do fluxo de campo elétrico através das paredes curvas do cilindro, são, respectivamente:`,
			image: '2025-2/em-5.webp'
		},
		alternatives: [
			{
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\bm{E} = \frac{3I_0}{2\pi(a + b)H\sigma}\hat{\rho}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\bm{E} = \frac{3I_0}{\pi(a^2 - b^2)\sigma}\hat{\rho}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\bm{E} = \frac{I_0}{6\pi(b - a)H\sigma}\hat{\rho}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\bm{E} = \frac{I_0}{6\pi(b - a)H\sigma}\hat{\varphi}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\bm{E} = \frac{I_0}{\pi(a^2 - b^2)\sigma}\hat{\varphi}$`,
	...
	},
	{
		...
		questionNumber: 7,
		statement: {
			text: String.raw`Um capacitor de placas paralelas sofre um processo de descarga quando suas placas condutoras são acopladas por um fio. O campo elétrico na região entre as placas é dado por<br/><br/>$$\bm{E} = -\frac{\sigma(t)}{\epsilon_0}\hat{z},$$<br/>sendo $\sigma(t)$ a densidade superficial de carga no instante $t$. Durante a descarga, o campo magnético $\bm{B}$ na região entre as placas:`
		},
		alternatives: [
			{
				text: String.raw`é proporcional a $d\sigma/dt$ e aponta na direção do vetor unitário $\hat{\phi}$.`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`é proporcional a $\sigma(t)$ e aponta na direção do vetor unitário $\hat{\phi}$.`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`é proporcional a $\sigma(t)$ e aponta na direção do vetor unitário $\hat{\rho}$.`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`é igual a 0, uma vez que o campo $\bm{E}$ entre as placas não pode variar.`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`é igual a 0, uma vez que que o campo $\bm{B}$ entre as placas é inicialmente nulo e não pode variar.`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 7,
		statement: {
			text: String.raw`Um capacitor de placas paralelas de área $A$ sofre um processo de descarga quando suas placas condutoras são acopladas por um fio. O campo elétrico na região entre as placas é dado por<br/><br/>$$\bm{E} = -\frac{Q(t)}{A\epsilon_0}\hat{z},$$<br/>sendo $Q(t)$ a carga sobre as placas no instante $t$. Durante a descarga, o campo magnético $\bm{B}$ na região entre as placas:`
		},
		alternatives: [
			{
				text: String.raw`é proporcional a $dQ/dt$ e aponta na direção do vetor unitário $\hat{\phi}$.`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`é proporcional a $Q(t)$ e aponta na direção do vetor unitário $\hat{\phi}$.`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`é proporcional a $Q(t)$ e aponta na direção do vetor unitário $\hat{\rho}$.`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`é igual a 0, uma vez que o campo $\bm{E}$ entre as placas não pode variar.`,
	...
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$\frac{1}{\sqrt{2}}c$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{1}{\sqrt{5}}c$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\frac{2}{3}c$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\frac{6}{7}c$`,
				number: QuestionAlternative.B
			},
			{
				text: 'Impossível, não há como combinar a contração de espaço e a dilatação da vida-média das partículas simultaneamente.',
			...
			{
				text: String.raw`$\frac{3}{5}c$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\frac{4}{7}c$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`De acordo com o modelo de Bohr, o raio da órbita $n = 1$ do átomo de hidrogênio é $a_0 \approx 5{,}3 \space \text{\AA}$ e a velocidade é $v_0 \approx 2{,}2 \times 10^6$ m/s. O raio e a velocidade da órbita $n = 3$ são, respectivamente,`
		},
		alternatives: [
			{
				text: String.raw`$9a_0$ e $\frac{1}{3}v_0$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$3a_0$ e $\frac{1}{9}v_0$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$9a_0$ e $\frac{1}{9}v_0$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$3a_0$ e $\frac{1}{3}v_0$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$3a_0$ e $\frac{1}{\sqrt{3}}v_0$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`De acordo com o modelo de Bohr, o raio da órbita $n = 1$ do átomo de hidrogênio é $a_0 \approx 5{,}3 \space \text{\AA}$ e a velocidade é $v_0 \approx 2{,}2 \times 10^6$ m/s. O raio e a velocidade da órbita $n = 2$ são, respectivamente,`
		},
		alternatives: [
			{
				text: String.raw`$4a_0$ e $\frac{1}{2}v_0$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$2a_0$ e $\frac{1}{4}v_0$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$4a_0$ e $\frac{1}{4}v_0$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$2a_0$ e $\frac{1}{2}v_0$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$2a_0$ e $\frac{1}{\sqrt{2}}v_0$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`A densidade de estados eletrônicos em um metal como função da energia $E$ (medida a partir do fundo da banda de valência) é $g(E) = A\sqrt{E}$, onde $A$ é uma constante. Sendo $E_F$ a energia de Fermi, qual o número total de estados ocupados $N$? Desconsidere a degenerescência de spin e, para seus cálculos, considere temperatura nula $T = 0$.`
		},
		alternatives: [
			{
				text: String.raw`$N = \frac{2}{3}AE_F^{3/2}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$N = \frac{1}{2}A/E_F^{1/2}$`,
				number: QuestionAlternative.B
			},
			{
				text: '$N = AE_F^{1/2}$',
	...
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`A densidade de estados eletrônicos em um metal como função da energia $E$ (medida a partir do fundo da banda de valência) é $g(E) = A\sqrt{E}$, onde $A$ é uma constante. Sendo $N$ o número total de estados ocupados, qual é o valor da energia de Fermi $E_F$? Desconsidere a degenerescência de spin e, para seus cálculos, considere temperatura nula $T = 0$.`
		},
		alternatives: [
			{
				text: String.raw`$E_F = \left(\frac{3N}{2A}\right)^{2/3}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$E_F = \left(\frac{N}{A}\right)^2$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$E_F = \left(\frac{A}{2N}\right)^2$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$E_F = \left(\frac{2N}{3A}\right)^{2/3}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$E_F = \frac{N}{A}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\mathcal{P}_{12} = \frac{2}{3}$ e $\mathcal{P}_2 = \frac{1}{3}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\mathcal{P}_{12} = \frac{2}{3}$ e $\mathcal{P}_2 = \frac{2}{3}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\mathcal{P}_{12} = \frac{1}{3}$ e $\mathcal{P}_2 = \frac{2}{3}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\mathcal{P}_{12} = 0$ e $\mathcal{P}_2 = \frac{2}{3}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\mathcal{P}_{12} = \frac{1}{3}$ e $\mathcal{P}_2 = \frac{1}{3}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Assinale a alternativa que melhor representa as funções de onda de uma partícula sujeita ao potencial unidimensional<br/><br/>$$V(x) = \begin{cases} \frac{m\omega^2 x^2}{2}, & x < 0 \\ \infty, & x > 0 \end{cases}.$$`
		},
		alternatives: [
			{
	...
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$\pm 2\hbar\omega_0$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Para garantir a estabilidade termodinâmica de um sistema, sua energia livre de Helmholtz por partícula, $f(T,v)$, deve satisfazer<br/><br/>$$\left(\frac{\partial^2 f}{\partial T^2}\right)_v \leq 0 \quad \text{e} \quad \left(\frac{\partial^2 f}{\partial v^2}\right)_T \geq 0,$$<br/>em que $v$ é o volume molar e $T$ é a temperatura. A partir dessas relações, e sendo<br/><br/>$$c_v = T\left(\frac{\partial s}{\partial T}\right)_v \quad \text{e} \quad \kappa_T = -\frac{1}{v}\left(\frac{\partial v}{\partial p}\right)_T,$$<br/>com $s$ a entropia por partícula e $p$ a pressão, é correto afirmar que`
		},
		alternatives: [
			{
				text: String.raw`$c_v \geq 0$ e $\kappa_T \geq 0$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$c_v \leq 0$ e $\kappa_T \geq 0$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$c_v \leq 0$ e $\kappa_T \leq 0$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$c_v \geq 0$ e $\kappa_T \leq 0$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$c_v = 0$ e $\kappa_T = 0$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		version: Version.A,
		area: Area.Termodinamica,
		tags: tagsForArea<Area.Termodinamica>(TagTD.SegundaLeiEntropia, TagTD.TrabalhoPrimeiraLei),
		help: {
			youtubeVideoId: videos[Area.Termodinamica]
		},
		questionNumber: 4,
		...
		alternatives: [
			{
				text: String.raw`$\Delta S = C_v\ln\left(\frac{9}{8}\right)$`,
				number: QuestionAlternative.A
			},
			{
			...
			{
				text: String.raw`$\Delta S = C_v\ln\left(\frac{3}{4}\right)$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\Delta S = C_v\ln\left(\frac{4}{3}\right)$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\Delta S = C_v\ln\left(\frac{25}{16}\right)$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\Delta S = C_v\ln\left(\frac{25}{4}\right)$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\Delta S = 0$`,
			...
			{
				text: String.raw`$\Delta S = C_v\ln\left(\frac{5}{2}\right)$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\Delta S = C_v\ln\left(\frac{2}{5}\right)$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Um sistema composto por $N$ partículas não interagentes está em contato com um reservatório térmico à temperatura $T$. Cada partícula pode ocupar apenas dois níveis de energia: o estado fundamental $\varepsilon_0 = 0$, não degenerado, ou o estado excitado $\varepsilon_1 = \varepsilon > 0$, que é triplamente degenerado. Nessas condições, e sendo $\beta^{-1} = k_B T$, a energia média por partícula do sistema é:`
		},
		alternatives: [
			{
				text: String.raw`$\frac{3\varepsilon e^{-\beta\varepsilon}}{1 + 3e^{-\beta\varepsilon}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$3\varepsilon$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\frac{3\varepsilon e^{-\beta\varepsilon}}{1 + e^{-\beta\varepsilon}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{\varepsilon e^{-\beta\varepsilon}}{1 + 3e^{-\beta\varepsilon}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\varepsilon$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\frac{2\varepsilon e^{-\beta\varepsilon}}{1 + 2e^{-\beta\varepsilon}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$2\varepsilon$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\frac{2\varepsilon e^{-\beta\varepsilon}}{1 + e^{-\beta\varepsilon}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\frac{\varepsilon e^{-\beta\varepsilon}}{1 + 2e^{-\beta\varepsilon}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\varepsilon$`,
	...
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Dois sistemas isolados, A e B, possuem respectivamente $\Omega_A = 10^3$ e $\Omega_B = 10^2$ microestados acessíveis. Eles são combinados para formar um sistema total $A + B$, sem interação entre eles. Supondo que todos os microestados continuem igualmente prováveis e acessíveis, a entropia total $S_{A+B}$ do sistema combinado e a probabilidade $p_j$ de ocorrência de cada microestado particular nesse sistema são, respectivamente:`
		},
		alternatives: [
			{
				text: String.raw`$S_{A+B} = 5k_B\ln 10$ e $p_j = 10^{-5}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$S_{A+B} = 6k_B\ln 10$ e $p_j = 10^{-5}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$S_{A+B} = k_B\ln 6$ e $p_j = 10^{-2}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$S_{A+B} = 5k_B\ln 10$ e $p_j = 10^{-2}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$S_{A+B} = 6k_B\ln 10$ e $p_j = 10^{-2}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Dois sistemas isolados, A e B, possuem respectivamente $\Omega_A = 10^2$ e $\Omega_B = 10^5$ microestados acessíveis. Eles são combinados para formar um sistema total $A + B$, sem interação entre eles. Supondo que todos os microestados continuem igualmente prováveis e acessíveis, a entropia total $S_{A+B}$ do sistema combinado e a probabilidade $p_j$ de ocorrência de cada microestado particular nesse sistema são, respectivamente:`
		},
		alternatives: [
			{
				text: String.raw`$S_{A+B} = 7k_B\ln 10$ e $p_j = 10^{-7}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$S_{A+B} = 10k_B\ln 10$ e $p_j = 10^{-7}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$S_{A+B} = k_B\ln 10$ e $p_j = 10^{-3}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$S_{A+B} = 7k_B\ln 10$ e $p_j = 10^{-3}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$S_{A+B} = 10k_B\ln 10$ e $p_j = 10^{-3}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`O deslocamento de um oscilador harmônico simples clássico é descrito por $x(t) = A\cos(\omega t + \phi)$. Considere então uma coleção desses osciladores, com mesma amplitude $A$ e frequência $\omega$, mas com fases $\phi$ distribuídas uniformemente no intervalo $[0, 2\pi)$. Para um instante de tempo $t$ arbitrário, a variância da posição dos osciladores, $\langle x^2 \rangle - \langle x \rangle^2$, é:`
		},
		alternatives: [
			{
				text: '$A^2/2$',
	...
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`O deslocamento de um oscilador harmônico simples clássico é descrito por $x(t) = A\cos(\omega t + \phi)$. Considere então um ensemble destes osciladores com mesma amplitude $A$ e frequência $\omega$, mas com fases $\phi$ distribuídas uniformemente no intervalo $[0, 2\pi)$. Para um instante de tempo $t$ arbitrário, o desvio padrão da posição dos osciladores, $\sqrt{\langle x^2 \rangle - \langle x \rangle^2}$, é:`
		},
		alternatives: [
			{
				text: String.raw`$A/\sqrt{2}$`,
				number: QuestionAlternative.A
			},
			{
				text: '$A/2$',
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$s_1 = s_2 = \pm 1$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$s_1 = -s_2$ e $s_2 = \pm 1$`,
				number: QuestionAlternative.B
			},
			{
				text: '$s_1 = s_2 = 0$',
			...
			{
				text: String.raw`$s_1 = 0$ e $s_2 = \pm 1$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$s_2 = 0$ e $s_1 = \pm 1$`,
				number: QuestionAlternative.E
			}
		]
	},
