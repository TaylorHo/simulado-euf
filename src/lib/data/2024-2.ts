...
const videos = {
	[Area.MecanicaClassica]: '2aDOe8MfxqQ',
	[Area.Eletromagnetismo]: 'kZEsh6R0PG4',
	[Area.FisicaModerna]: '9MnLR30eFCo',
	[Area.MecanicaQuantica]: '2e97Hjyvazs',
	[Area.Termodinamica]: '4Q4b4BLyMAU',
	[Area.FisicaEstatistica]: 'tZkx1x8ocro'
};
...
export default <Question[]>[
	{
		...
		tags: tagsForArea<Area.MecanicaClassica>(
			TagMC.ForcasCentrais,
			TagMC.GravitacaoNewtoniana,
		...
		alternatives: [
			{
				text: String.raw`$\omega = \sqrt{\frac{3GM}{a^3}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\omega = \sqrt{\frac{3GM}{2a^3}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\omega = \sqrt{\frac{\sqrt{3}GM}{a^3}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\omega = \sqrt{\frac{2GM}{3a^3}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\omega = \sqrt{\frac{GM}{3a^3}}$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$a = (\frac{3GM}{\omega^2})^{\frac{1}{3}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$a = (\frac{3GM}{2\omega^2})^{\frac{1}{3}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$a = (\frac{\sqrt{3}GM}{\omega^2})^{\frac{1}{3}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$a = (\frac{2GM}{3\omega^2})^{\frac{1}{3}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$a = (\frac{GM}{3\omega^2})^{\frac{1}{3}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		version: Version.A,
		area: Area.MecanicaClassica,
		tags: tagsForArea<Area.MecanicaClassica>(TagMC.LeisDeNewton, TagMC.ReferenciaisNaoInerciais),
		help: {
			youtubeVideoId: videos[Area.MecanicaClassica]
		},
		questionNumber: 3,
	...
	},
	{
		...
		version: Version.A,
		area: Area.MecanicaClassica,
		tags: tagsForArea<Area.MecanicaClassica>(TagMC.OscilacoesLineares, TagMC.DinamicaCorposRigidos),
		help: {
			imageDescription: undefined,
			youtubeVideoId: videos[Area.MecanicaClassica]
		},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$h = \frac{4}{9}H$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$h = \frac{2}{3}H$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$h = \frac{1}{3}H$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$h = \frac{1}{9}H$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$h = \frac{8}{9}H$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$h = \frac{9}{16}H$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$h = \frac{3}{4}H$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$h = \frac{1}{4}H$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$h = \frac{1}{16}H$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$h = \frac{3}{16}H$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	// Questão 7 foi anulada
	{
		...
		alternatives: [
			{
				text: String.raw`$p_x = (m + M)\dot{x} + mL\dot{\theta} \cos{\theta}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$p_x = (m + M)\dot{x}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$p_x = (m + M)\dot{x} + mL\dot{\theta} \sin{\theta}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$p_x = (m + M)\dot{x} - mL\dot{\theta} \sin{\theta}$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$p_{\theta} = mL^2\dot{\theta} + mL\dot{x} \cos{\theta}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$p_{\theta} = mL^2\dot{\theta}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$p_{\theta} = mL^2\dot{\theta} + mL\dot{x} \sin{\theta}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$p_{\theta} = mL^2\dot{\theta} - mL\dot{x} \cos{\theta}$`,
	...
	},
	{
		...
		questionNumber: 1,
		statement: {
			text: String.raw`Um isolante cilíndrico de raio $R$, infinitamente longo, possui uma distribuição uniforme de cargas com densidade volumétrica $\nu > 0$. Qual é o módulo do campo elétrico $E$ a uma distância $\rho < R$ do eixo de simetria do cilindro?`
		},
		alternatives: [
			{
				text: String.raw`$E = \frac{\nu \rho}{2\epsilon_0}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$E = \frac{\nu \rho}{4\epsilon_0}$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$t = RC \ln{2}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$t = RC \ln{3}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$t = \frac{1}{2} RC \ln{2}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$t = \frac{1}{3} RC \ln{3}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$t = 2RC \ln{3}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$t = \frac{1}{2} RC \ln{3}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$t = \frac{1}{3} RC \ln{2}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$t = 3RC \ln{3}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$B = \frac{\mu_0 I}{2 \pi \rho} \hat{\phi}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$B = \frac{\mu_0 I}{4 \pi \rho} \hat{\phi}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$B = \frac{\mu_0 I a}{2 \pi \rho^2} \hat{\phi}$`,
			...
			{
				text: String.raw`$B = \frac{\mu_0 I b}{2 \pi \rho^2} \hat{\phi}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$B = \frac{\mu_0 I b}{2 \pi a \rho} \hat{\phi}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Em uma determinada região do espaço o campo elétrico é dado, em coordenadas esféricas, por $E = kr^2\hat{r}$, onde $k$ é uma constante. Qual é a densidade de carga $\rho$ na região?`
		},
		alternatives: [
			{
				text: String.raw`$\rho = 4 k \epsilon_0 r$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\rho = 2\pi k \epsilon_0 r$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\rho = 4\pi k \epsilon_0 r$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\rho = k \epsilon_0 r$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\rho = \pi k \epsilon_0 r$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Em uma determinada região do espaço o campo elétrico é dado, em coordenadas esféricas, por $E = kr^3\hat{r}$, onde $k$ é uma constante. Qual é a densidade de carga $\rho$ na região?`
		},
		alternatives: [
			{
				text: String.raw`$\rho = 5 k \epsilon_0 r^2$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\rho = 5\pi k \epsilon_0 r^2$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\rho = 10 k \epsilon_0 r^2$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\rho = 10\pi k \epsilon_0 r^2$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\rho = 4\pi k \epsilon_0 r^2$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$B = \frac{\mu_0 I_0}{4} (\frac{1}{R_1} + \frac{1}{R_2}) \hat{z}$`,
				number: QuestionAlternative.A
			},
			{
				text: '$B = 0$',
			...
			{
				text: String.raw`$B = \frac{\mu_0 I_0}{4} (\frac{1}{R_2} - \frac{1}{R_1}) \hat{z}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		questionNumber: 6,
		statement: {
			text: String.raw`O potencial vetor de certa distribuição de corrente elétrica em uma região do espaço é dado, em coordenadas cilíndricas, por $A(\rho,\phi,z) = \frac{1}{2}C_0\rho\hat{\phi}$, com $C_0$ constante. $i)$ Calcule o campo magnético $B(\rho,\phi,z)$; $ii)$ Em que região espacial próxima a qual distribuição de corrente elétrica pode-se observar esse campo magnético?`
		},
		alternatives: [
			{
				text: String.raw`$B(\rho,\phi,z) = C_0\hat{z}$; interior de um solenoide longo`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$B(\rho,\phi,z) = \frac{1}{4}C_0\rho^2\hat{z}$; proximidades de um fio retilíneo longo`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$B(\rho,\phi,z) = C_0\hat{\phi}$; interior de um solenoide longo`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$B(\rho,\phi,z) = \frac{1}{2}C_0\hat{\phi}$; ao longo do eixo de uma espira circular`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$B(\rho,\phi,z) = C_0\hat{\phi}$; ao longo do eixo de uma espira circular`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 6,
		statement: {
			text: String.raw`O potencial vetor de certa distribuição de corrente elétrica em uma região do espaço é dado, em coordenadas cilíndricas, por $A(\phi,\rho,z) = -C_0 \ln{(\rho/a)}\hat{z}$, com $C_0$ e $a$ constantes. $i)$ Calcule o campo magnético $B(\rho,\phi,z)$; $ii)$ Em que região espacial próxima a qual distribuição de corrente elétrica pode-se observar esse campo magnético?`
		},
		alternatives: [
			{
				text: String.raw`$B(\rho,\phi,z) = \frac{C_0}{\rho}\hat{\phi}$; proximidades de um fio retilíneo longo`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$B(\rho,\phi,z) = C_0(\frac{a}{\rho})\hat{\phi}$; proximidades de um fio retilíneo longo`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$B(\rho,\phi,z) = \frac{C_0}{\rho}\hat{\phi}$; ao longo do eixo de uma espira circular`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$B(\rho,\phi,z) = C_0(\frac{a}{\rho})\hat{z}$; interior de um solenoide longo`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$B(\rho,\phi,z) = C_0\rho\hat{z}$; interior de um solenoide longo`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$v_f = 2{,}0 \times 10^8 \space m/s; \space n = 1{,}5; \space B(z,t) = -\frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (3\hat{x} - \hat{y})$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$v_f = 2{,}0 \times 10^8 \space m/s; \space n = 1{,}5; \space B(z,t) = \frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (3\hat{x} + \hat{y})$`,
			...
			{
				text: String.raw`$v_f = 5{,}0 \times 10^8 \space m/s; \space n = 6{,}0; \space B(z,t) = -\frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (3\hat{x} - \hat{y})$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$v_f = 5{,}0 \times 10^8 \space m/s; \space n = 6{,}0; \space B(z,t) = \frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (3\hat{x} + \hat{y})$`,
			...
			{
				text: String.raw`$v_f = 1{,}5 \times 10^8 \space m/s; \space n = 2{,}0; \space B(z,t) = \frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (\hat{x} - 3\hat{y})$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$v_f = 2{,}5 \times 10^8 \space m/s; \space n = 1{,}2; \space B(z,t) = \frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (\hat{x} + 2\hat{y})$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$v_f = 2{,}5 \times 10^8 \space m/s; \space n = 1{,}2; \space B(z,t) = \frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (\hat{x} - 2\hat{y})$`,
			...
			{
				text: String.raw`$v_f = 4{,}0 \times 10^8 \space m/s; \space n = 7{,}5; \space B(z,t) = -\frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (\hat{x} + 2\hat{y})$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$v_f = 4{,}0 \times 10^8 \space m/s; \space n = 7{,}5; \space B(z,t) = -\frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (\hat{x} - 2\hat{y})$`,
			...
			{
				text: String.raw`$v_f = 7{,}5 \times 10^8 \space m/s; \space n = 4{,}0; \space B(z,t) = \frac{k E_0}{\omega} \exp{[i(kz - \omega t)]} (2\hat{x} + \hat{y})$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 8,
		statement: {
			text: String.raw`Uma espira condutora quadrada de lado $D$ encontra-se no interior de um solenoide longo de comprimento $L$ e de secção reta circular de raio $a (a \ll L)$. O plano da espira é perpendicular ao eixo do solenoide. O número total de voltas do solenoide é $N$ e a corrente elétrica que nele circula é dada por $I(t) = I_0 \cos{\omega t}$. Qual é a força eletromotriz $\varepsilon$ induzida na espira?`
		},
		alternatives: [
			{
				text: String.raw`$\varepsilon = \frac{\omega \mu_0 I_0 N D^2}{L} \sin{\omega t}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\varepsilon = \frac{\omega \mu_0 I_0 N D^2}{L} \cos{\omega t}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\varepsilon = \frac{\mu_0 I_0 N^2 D^2}{L^2} \sin{\omega t}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\varepsilon = \frac{\mu_0 I_0 N (\pi a^2)}{L} \cos{\omega t}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\varepsilon = \frac{\mu_0 I_0 N^2 (\pi a^2)}{L^2} \sin{\omega t}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 8,
		statement: {
			text: String.raw`Uma espira condutora quadrada de lado $C$ encontra-se no interior de um solenoide longo de comprimento $L$ e de secção reta circular de raio $b (b \ll L)$. O plano da espira é perpendicular ao eixo do solenoide. O número total de voltas do solenoide é $N$ e a corrente elétrica que nele circula é dada por $I(t) = I_0 \sin{\omega t}$. Qual é a força eletromotriz $\varepsilon$ induzida na espira?`
		},
		alternatives: [
			{
				text: String.raw`$\varepsilon = -\frac{\omega \mu_0 I_0 N C^2}{L} \cos{\omega t}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\varepsilon = \frac{\omega \mu_0 I_0 N C^2}{L} \sin{\omega t}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\varepsilon = -\frac{\mu_0 I_0 N^2 C^2}{L^2} \cos{\omega t}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\varepsilon = \frac{\mu_0 I_0 N (\pi b^2)}{L} \sin{\omega t}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\varepsilon = -\frac{\mu_0 I_0 N^2 (\pi b^2)}{L^2} \cos{\omega t}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`As matrizes $S_{\alpha}$ $(\alpha = x,y,z)$, que representam as componentes do operador de spin $S$ de uma partícula de spin $1/2$, são dadas, na representação em que $S_z$ é diagonal, por $S_{\alpha} = (\hbar/2)\sigma_{\alpha}$, onde $\sigma_{\alpha}$ são as matrizes de Pauli, dadas no Formulário. Suponha que uma partícula de spin $1/2$ esteja submetida a um campo magnético constante e uniforme que aponta na direção $z$. O estado de spin da partícula, como função do tempo $t$, na mesma representação, é<br/><br/>$$\frac{1}{2} \left(\begin{matrix}e^{i \omega t / 2} \\ \sqrt{3}e^{-i \omega t / 2}\end{matrix}\right) \space \text{,}$$<br/>onde $\omega$ é proporcional ao campo magnético. Obtendo os valores esperados das componentes $x$ e $z$ do spin, $\langle S_x \rangle$ e $\langle S_z \rangle$, respectivamente, identifique a opção correta dentre as afirmativas abaixo.`
		},
		alternatives: [
			{
				text: String.raw`O valor esperado do spin, $\langle S \rangle$, precessiona em torno da direção do campo magnético, mantendo um ângulo constante com essa direção, isto é, com $\langle S_z \rangle$ constante.`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`O valor esperado do spin, $\langle S \rangle$, precessiona em torno do eixo $x$, mantendo um ângulo constante com a direção $x$, isto é, com $\langle S_x \rangle$ constante.`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`O valor esperado do spin, $\langle S \rangle$, precessiona em torno da direção do campo magnético, com $\langle S_z \rangle$ oscilando entre $-\hbar/2$ e $+\hbar/2$.`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`O valor esperado do spin, $\langle S \rangle$, é independente do tempo e tem módulo $+\hbar/2$ ao longo da direção do campo magnético.`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`O valor esperado do spin, $\langle S \rangle$, é independente do tempo e tem módulo $+\hbar/2$ ao longo do eixo $x$.`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`O valor esperado do spin, $\langle S \rangle$, precessiona em torno do eixo $y$, mantendo um ângulo constante com a direção $y$, isto é, com $\langle S_y \rangle$ constante.`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`O valor esperado do spin, $\langle S \rangle$, precessiona em torno da direção do campo magnético, com $\langle S_z \rangle$ oscilando entre $-\hbar/2$ e $+\hbar/2$.`,
			...
			{
				text: String.raw`O valor esperado do spin, $\langle S \rangle$, é independente do tempo e tem módulo $+\hbar/2$ ao longo do eixo $y$.`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$N = \sqrt{2/a}$ e $E = 2\hbar^2\pi^2 / ma^2$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$N = 2/a$ e $E = 2\hbar^2\pi^2 / ma^2$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$N = \sqrt{2/a}$ e $E = \hbar^2\pi^2 / ma^2$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$N = 2/\sqrt{a}$ e $E = \hbar^2\pi^2 / ma^2$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$N = \sqrt{2/a}$ e $E = \hbar^2\pi^2 / 2ma^2$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$N = 2/a$ e $E = \hbar^2\pi^2 / 2ma^2$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$N = \sqrt{2/a}$ e $E = \hbar^2\pi^2 / ma^2$`,
			...
			{
				text: String.raw`$N = 2/\sqrt{a}$ e $E = 2\hbar^2\pi^2 / ma^2$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$N = \sqrt{2/a}$ e $E = 2\hbar^2\pi^2 / ma^2$`,
	...
	},
	{
		...
		questionNumber: 7,
		statement: {
			text: String.raw`Supondo que seja possível determinar que o módulo do momento angular orbital do elétron em um átomo de hidrogênio, em um dado instante de tempo, seja $L = \sqrt{2}\hbar$, quais seriam os resultados possíveis de uma medição imediatamente posterior de $L_z$, a componente $z$ de $\vec{L}$?`
		},
		alternatives: [
			{
				text: String.raw`$-\hbar, 0, \hbar$`,
				number: QuestionAlternative.A
			},
			{
				text: '$0$',
			...
			{
				text: String.raw`$0, \hbar$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$0, \hbar, 2\hbar$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$-2\hbar, -\hbar, 0, \hbar, 2\hbar$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 7,
		statement: {
			text: String.raw`Supondo que seja possível determinar que o módulo do momento angular orbital do elétron em um átomo de hidrogênio, em um dado instante de tempo, seja $L = \sqrt{6}\hbar$, quais seriam os resultados possíveis de uma medição imediatamente posterior de $L_z$, a componente $z$ de $\vec{L}$?`
		},
		alternatives: [
			{
				text: String.raw`$-2\hbar, -\hbar, 0, \hbar, 2\hbar$`,
			...
			{
				text: String.raw`$0, 3\hbar$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$0, \hbar, 2\hbar, 3\hbar$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$-\hbar, 0, \hbar$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\ket{\psi (t)} = (e^{-i \omega t}\ket{a} + e^{i \omega t}\ket{b} + e^{-2i \omega t}\ket{c}) / \sqrt{3}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\ket{\psi (t)} = (e^{i \omega t}\ket{a} + e^{-i \omega t}\ket{b} + e^{2i \omega t}\ket{c}) / \sqrt{3}$`,
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\ket{\psi (t)} = (e^{-i \omega t}\ket{a} + e^{-2i \omega t}\ket{b} + e^{2i \omega t}\ket{c}) / \sqrt{3}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\ket{\psi (t)} = (e^{i \omega t}\ket{a} + e^{2i \omega t}\ket{b} + e^{-2i \omega t}\ket{c}) / \sqrt{3}$`,
	...
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Uma bomba de massa de repouso m explode e se fragmenta em três pedaços cujas massas de repouso são $m_1 = \frac{1}{4}m$, $m_2 = \frac{4}{9}m$ e $m_3 = \frac{11}{36}m$. As velocidades dos fragmentos 1 e 2 no referencial da bomba imediatamente após a explosão são iguais a $V_1 = \frac{4}{5}c\hat{x}$ e $V_2 = -\frac{3}{5}c\hat{x}$, respectivamente, onde $c$ é a velocidade da luz no vácuo. Qual é a velocidade do terceiro fragmento?`
		},
		alternatives: [
			{
				text: '$V_3 = 0$',
			...
			{
				text: String.raw`$V_3 = -\frac{12}{55}c\hat{x}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$V_3 = \frac{12}{55}c\hat{x}$`,
			...
			{
				text: String.raw`$V_3 = -\frac{2}{5}c\hat{x}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$V_3 = \frac{1}{5}c\hat{x}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Uma bomba de massa de repouso m explode e se fragmenta em três pedaços cujas massas de repouso são $m_1 = \frac{5}{9}m$, $m_2 = \frac{5}{16}m$ e $m_3 = \frac{19}{144}m$. As velocidades dos fragmentos 1 e 2 no referencial da bomba imediatamente após a explosão são iguais a $V_1 = \frac{3}{5}c\hat{x}$ e $V_2 = -\frac{4}{5}c\hat{x}$, respectivamente, onde $c$ é a velocidade da luz no vácuo. Qual é a velocidade do terceiro fragmento?`
		},
		alternatives: [
			{
				text: '$V_3 = 0$',
			...
			{
				text: String.raw`$V_3 = -\frac{12}{19}c\hat{x}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$V_3 = \frac{12}{19}c\hat{x}$`,
	...
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Em uma sauna, a temperatura do ambiente é de $45^\circ C$. Qual é a ordem de grandeza da potência de calor absorvida por irradiação por uma pessoa cuja área superficial é de $2{,}1 m^2$? Considere o ambiente e a pessoa como corpos negros perfeitos.`
		},
		alternatives: [
			{
				text: '$10^3 W$',
	...
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Em uma sauna, a temperatura do ambiente é de $47^\circ C$. Qual é a ordem de grandeza da potência de calor absorvida por irradiação por uma pessoa cuja área superficial é de $1{,}9 m^2$? Considere o ambiente e a pessoa como corpos negros perfeitos.`
		},
		alternatives: [
			{
				text: '$10^3 W$',
	...
	},
	{
		...
		area: Area.FisicaModerna,
		tags: tagsForArea<Area.FisicaModerna>(
			TagFM.CausalidadeSimultaneidade,
	...
	},
	{
		...
		questionNumber: 8,
		statement: {
			text: String.raw`Um fóton com um comprimento de onda de $102{,}6$ nm é emitido por um átomo de hidrogênio. As energias do átomo de hidrogênio são dadas por $E_n = -13{,}6 \space eV/n^2$, onde $n$ é o número quântico principal do estado em que o elétron se encontra. Qual é o valor de $n$ do estado em que o elétron se encontrava antes da emissão do fóton?`
		},
		alternatives: [
			{
				text: '$3$',
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\Delta{S} = C_v (1 - \ln{2})$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\Delta{S} = C_v$`,
				number: QuestionAlternative.B
			},
			{
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\Delta{S} = C_v (\ln{2} - \frac{1}{2})$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\Delta{S} = \frac{C_v}{2}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\Delta{S} = C_v \ln{2}$`,
	...
	},
	{
		...
		alternatives: [
			...
			{
				text: String.raw`$W = RT \ln{(\frac{2v_0 - b}{v_0 - b})} + \frac{a}{2v_0}$ e $T_f = T_0$`,
				number: QuestionAlternative.C
			},
			{
				text: '$W = 0$ e $T_f = T_0$',
			...
			{
				text: String.raw`$W = RT \ln{(\frac{2v_0 - b}{v_0 - b})} + \frac{a}{2v_0}$ e $T_f = T_0 - \frac{a}{2v_0 Rc}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$W = 0$ e $T_f = T_0 - \frac{2a}{3v_0 Rc}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$W = 0$ e $T_f = T_0 + \frac{2a}{3v_0 Rc}$`,
			...
			{
				text: String.raw`$W = RT \ln{(\frac{3v_0 - b}{v_0 - b})} + \frac{2a}{3v_0}$ e $T_f = T_0$`,
				number: QuestionAlternative.C
			},
			{
				text: '$W = 0$ e $T_f = T_0$',
			...
			{
				text: String.raw`$W = RT \ln{(\frac{3v_0 - b}{v_0 - b})} + \frac{2a}{3v_0}$ e $T_f = T_0 - \frac{2a}{3v_0 Rc}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`Considere um mol de um gás ideal monoatômico ($C_V = \frac{3R}{2}$) que realiza um processo cíclico quase-estático A-B-C-A, conforme ilustra a figura. A etapa A-B é isocórica, a etapa B-C é isotérmica e a etapa C-A é isobárica. O trabalho realizado pelo gás ao longo do ciclo é:`,
			image: '2024-2/te-3a.webp'
		},
		alternatives: [
			{
				text: String.raw`$W_{ciclo} = P_0 V_0 (\ln{4} - 1)$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$W_{ciclo} = P_0 V_0 (\ln{4} + 1)$`,
			...
			{
				text: String.raw`$W_{ciclo} = P_0 V_0 (\ln{4} - 2)$`,
				number: QuestionAlternative.C
			},
			{
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$W_{ciclo} = P_0 V_0 (\ln{27} - 2)$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$W_{ciclo} = P_0 V_0 (\ln{27} + 2)$`,
			...
			{
				text: String.raw`$W_{ciclo} = P_0 V_0 (\ln{9} - 2)$`,
				number: QuestionAlternative.C
			},
			{
	...
	},
	{
		...
		version: Version.A,
		area: Area.Termodinamica,
		tags: tagsForArea<Area.Termodinamica>(TagTD.FuncoesTermodinamicas, TagTD.SegundaLeiEntropia),
		help: {
			youtubeVideoId: videos[Area.Termodinamica]
		},
		questionNumber: 4,
		statement: {
			text: String.raw`Considere um certo gás realizando um processo de compressão adiabática quase-estática (em que não há trocas de calor) indo de uma pressão inicial $P_0$ a uma pressão final $P_f \gt P_0$. Se $N,V$ são o número de mols e volume, respectivamente, e $S$, $U$, $F$ e $H$ os potenciais termodinâmicos entropia, energia interna, energia livre de Helmholtz e entalpia, respectivamente, a quantidade física que caracteriza a variação de temperatura ao longo deste processo é dada por:`
		},
		alternatives: [
			{
				text: String.raw`$(\frac{\partial T}{\partial P})_{S,N}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$(\frac{\partial T}{\partial P})_{V,N}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$(\frac{\partial T}{\partial P})_{U,N}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$(\frac{\partial T}{\partial P})_{F,N}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$(\frac{\partial T}{\partial P})_{H,N}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 4,
		statement: {
			text: String.raw`Considere um certo gás realizando um processo de expansão adiabática quase-estática (em que não há trocas de calor) indo de um volume inicial $V_0$ a um volume final $V_f \gt V_0$. Se $N,P$ são o número de mols e pressão, respectivamente, e $S$, $U$, $F$ e $H$ os potenciais termodinâmicos entropia, energia interna, energia livre de Helmholtz e entalpia, respectivamente, a quantidade física que caracteriza a variação de temperatura ao longo deste processo é dada por:`
		},
		alternatives: [
			{
				text: String.raw`$(\frac{\partial T}{\partial V})_{S,N}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$(\frac{\partial T}{\partial V})_{P,N}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$(\frac{\partial T}{\partial V})_{U,N}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$(\frac{\partial T}{\partial V})_{F,N}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$(\frac{\partial T}{\partial V})_{H,N}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Uma estrela composta essencialmente de hidrogênio está a uma temperatura $T$. Os níveis de energia do átomo de hidrogênio são dados por:<br/><br/>$$E_n = -\frac{a}{n^2}, \quad (n = 1, 2, 3, ...).$$<br/>A degenerescência do nível $n$ é $g_n = 2n^2$. A razão entre o número de átomos no segundo estado excitado ($n = 3$) e aqueles no estado fundamental ($n = 1$) é:`
		},
		alternatives: [
			{
				text: String.raw`$9e^{-\frac{8 \alpha}{9k_BT}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$3e^{-\frac{4 \alpha}{5k_BT}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$6e^{-\frac{2 \alpha}{9k_BT}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$4e^{-\frac{\alpha}{2k_BT}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$2e^{-\frac{8 \alpha}{3k_BT}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 2,
		statement: {
			text: String.raw`Uma estrela composta essencialmente de hidrogênio está a uma temperatura $T$. Os níveis de energia do átomo de hidrogênio são dados por:<br/><br/>$$E_n = -\frac{a}{n^2}, \quad (n = 1, 2, 3, ...).$$<br/>A degenerescência do nível $n$ é $g_n = 2n^2$. A razão entre o número de átomos no primeiro estado excitado ($n = 2$) e aqueles no estado fundamental ($n = 1$) é:`
		},
		alternatives: [
			{
				text: String.raw`$4e^{-\frac{3 \alpha}{4k_BT}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$8e^{-\frac{2 \alpha}{5k_BT}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$3e^{-\frac{2 \alpha}{3k_BT}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$2e^{-\frac{5 \alpha}{6k_BT}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$e^{-\frac{\alpha}{k_BT}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		version: Version.A,
		area: Area.FisicaEstatistica,
		tags: tagsForArea<Area.FisicaEstatistica>(TagFE.EnsembleCanonico, TagFE.GasIdealFermi),
		help: {
			youtubeVideoId: videos[Area.FisicaEstatistica]
		},
		questionNumber: 3,
		statement: {
			text: String.raw`Considere um sistema de 2 átomos. Cada átomo pode estar em um de três estados quânticos com energias $0$, $\epsilon$ e $2\epsilon$. O sistema está em contato com um reservatório térmico a uma temperatura $T$. Supondo que os átomos sejam férmions sem spin, a função de partição canônica do sistema é:`
		},
		alternatives: [
			{
				text: String.raw`$e^{-\frac{\epsilon}{k_BT}} + e^{\frac{-2\epsilon}{k_BT}} + e^{\frac{-3\epsilon}{k_BT}}$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$1 + e^{\frac{-\epsilon}{k_BT}} + e^{\frac{-2\epsilon}{k_BT}}$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$e^{\frac{-\epsilon}{k_BT}} + e^{\frac{-2\epsilon}{k_BT}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$1 + e^{-\frac{2\epsilon}{k_BT}} + e^{\frac{-3\epsilon}{k_BT}}$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$1 + e^{-\frac{\epsilon}{k_BT}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	{
		...
		questionNumber: 3,
		statement: {
			text: String.raw`Considere um sistema de 2 átomos. Cada átomo pode estar em um de dois estados quânticos com energias $0$ e $\epsilon$. O sistema está em contato com um reservatório térmico a uma temperatura $T$. Supondo que os átomos sejam bósons sem spin, a função de partição canônica do sistema é:`
		},
		alternatives: [
			{
				text: String.raw`$1 + e^{-\frac{\epsilon}{k_BT}} + e^{-\frac{2\epsilon}{k_BT}}$`,
			...
			{
				text: String.raw`$e^{-\frac{\epsilon}{k_BT}} + e^{-\frac{2\epsilon}{k_BT}} + 2e^{-\frac{3\epsilon}{k_BT}}$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$1 + e^{-\frac{\epsilon}{k_BT}}$`,
			...
			{
				text: String.raw`$e^{-\frac{2\epsilon}{k_BT}} + e^{-\frac{3\epsilon}{k_BT}} + e^{-\frac{4\epsilon}{k_BT}}$`,
				number: QuestionAlternative.E
			}
		]
	},
	...
	},
	{
		...
		alternatives: [
			{
				text: String.raw`$\langle z \rangle = k_BT$`,
				number: QuestionAlternative.A
			},
			{
				text: String.raw`$\langle z \rangle = k_BT/2$`,
				number: QuestionAlternative.B
			},
			{
				text: String.raw`$\langle z \rangle = 3k_BT$`,
				number: QuestionAlternative.C
			},
			{
				text: String.raw`$\langle z \rangle = 3k_BT/2$`,
				number: QuestionAlternative.D
			},
			{
				text: String.raw`$\langle z \rangle = 0$`,
